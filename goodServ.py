...
def get_non_blocking_server_socket():
    ...
    return server
def handle_readables(readables, server,server_json_file):
    """
...
if __name__ == '__main__':
    if len(sys.argv)!=2:
        print("Usage:server <file to save json>")
        sys.exit(1)      
    server_json_file=sys.argv[1]
    ...
    try:
        while INPUTS:
            ...
            handle_readables(readables, server_socket,server_json_file)
